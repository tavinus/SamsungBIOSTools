...
I am creating this repo to organize the data and knowledge from the thread into a smaller and simpler footprint. It is also a way to backup the data from there.

This will also summarize my experiences messing with a Samsung ATIV Book 6 670Z5E-XD2 that has been "erratic" for some time, and do not accept a fresh Windows 10 install (or installs and breaks after update).
